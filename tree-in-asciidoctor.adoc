...
We know of two Asciidoctor extensions tackeling this problem:
...
These approaches show some drawbacks:
...
For reference, we show how the tree rendering looks like without any styling.

.Barebons tree rendering
[source, asciidoc]
....
...
.Trick PlantUML into a sequence diagram to drop dependency on Graphviz
[source, asciidoc]
....
include::nodot.adoc[]
....
